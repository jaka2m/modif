...
async function randomconfig() {
  try {
    const HOSTKU2 = "jamal.gpj2.dpdns.org";
...
\u{1F310} [WEB VPN TUNNEL](https://jamal.gpj2.dpdns.org)
...
var worker_default = {
  async fetch(request, env) {
    ...
    try {
      ...
      const token = "8260084773:AAG4TZ4A-yf0cIkqC4H0fgm14x_Cz4Y1wkw";
